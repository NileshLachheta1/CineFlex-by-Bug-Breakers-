...
function MovieDetails(){
    ...
    <div class="container">
        <h2 class="h3 text-white mb-3 mt-5">About the Movie</h2>
        <p class="mt-lg-5 text-white fs-5 fw-light">This is the story of a son whose love for his father knows no
            bounds.
    ...
    <div class="container">
        <h2 class="h3 text-white mb-5 mt-5">Cast</h2>
    ...
    <div class="container">
        <h2 class="h3 text-white mb-3 ">Crew</h2>
        <div class="slider" id={styles.movieDetailSlider}>
            <div class={`${styles.cardContent} mb-5 `}>
                <div class="card" id={styles.sliderCard}>
                    <img src={cel1} alt=""/>
   ...
   <div class="container">
        <h2 class="h3 text-white mb-5 mt-5">Top Review</h2>
        <div class="slider" id={styles.movieDetailSlider}>
            <div class={`${styles.reviewContent} mb-5`}>
