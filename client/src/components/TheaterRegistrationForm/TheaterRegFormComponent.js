...
function TheaterRegFormComponent() {
  ...
  const submitRegData = async (event) => {
    ...
    if (result.status == 201) {
      ...
      navigate("/login", {
        messege:
          "Your account application has been sent to the admin, your account will be activate within 24 hours !",
      });
    } else {
      Swal.fire({
        icon: "error",
          ...
          <form onSubmit={submitRegData} encType="multipart/form-data">
            <div id="carouselExample" className="carousel slide">
              <div className="carousel-inner">
                {/* <!-- ........................first slide start....................................... --> */}
                <div
                  className="carousel-item carousel-item1  active"
                  onClick={() => {
                    console.log(
                      "1st slide clicked .................................."
                    );
                ...
                <div className="carousel-item carousel-item1 ">
                  ...
                  <div className="row p-3">
                    ...
                    <div className="col-sm-12 col-md-6 col-xl-6 p-4">
                      ...
                      <div className="">
                        <h6 className="text-white ms-2 mt-4">
                          <b> Uplode Your Theater 360 Image</b>
                        </h6>
                        <input
                          type="file"
                          id=""
              ...
              <div className=" d-grid gap-2 d-md-flex justify-content-md-end me-4 ">
                <button
                  className="btn bg-primary TheaterReg-btn preBtn"
                  type="button"
                ...
                <button
                  className="btn TheaterReg-btn nextBtn"
                  style={{ backgroundColor: "#ff0000d0" }}
                  type="button"
                  data-bs-target="#carouselExample"
                  data-bs-slide="next"
                >
                ...
                <button
                  className="btn TheaterReg-btn"
                  type="submit"
                  id="TheaterReg-submitBtn"
                >
                  Submit
                </button>
              </div>
